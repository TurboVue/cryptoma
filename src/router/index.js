        ...
        children: [
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "Transactions" */ "../views/Converter.vue"
              ),
            meta: { requiresAuth: true },
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "Transactions" */ "../views/Barcode.vue"
              ),
            meta: { requiresAuth: true },
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "Transactions" */ "../views/Proof.vue"
              ),
            meta: { requiresAuth: true },
          },
        ],
        ...
        children: [
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "Transactions" */ "../views/Profile.vue"
              ),
            meta: { requiresAuth: true },
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "Transactions" */ "../views/Payment.vue"
              ),
            meta: { requiresAuth: true },
          },
          {
            ...
            component: () =>
              import(
                /* webpackChunkName: "Transactions" */ "../views/Security.vue"
              ),
            meta: { requiresAuth: true },
          },
        ],
