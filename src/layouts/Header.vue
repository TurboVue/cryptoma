...
<template>
    <header class="flex py-5 px-4 bg-white md:static fixed inset-x-0 top-0 w-full justify-between items-center">
            <div class="logo w-10 mx-2">
                <img src="/img/logo.svg" class="w-full" alt="">
            </div>
            <div class="capitalize flex items-center">
                <ProfilePic :isSize= "'small'" :name="fullname"/><span class="md:hidden font-medium px-2">{{fullname}}</span>
            </div>
