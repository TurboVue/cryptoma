...
<template>
  <header
    ...
    "
  >
      <div class="flex justify-center my-2 items-center select-none flex-row">
      <div>
    ...
    <div class="px-4"><el-button  @click="() => $router.push({'path': '/'})" color="#1D4ED8" style="color: white">Users Dashboard</el-button></div>
